...
class CBedLevelComtrol:
    ...
    def on_file_selected(self,origin,path,analysis=None):
        self._path=path
        self._origin=origin
        if analysis :
...
class CextPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def on_after_startup(self):
        ...
        self.probe_area_control=CBedLevelComtrol(self.cmdList,self.control_progress_cb,self.level)
    ...
    def on_event(self, event, payload):
        ...
        if(event=='FileSelected'):
            ...
            if self.probe_area_control:
                self.probe_area_control.on_file_selected(origin,path,analysis)
            self._update_front()
            return
